...
public class CustomerApiController {
	...
	public Customer createCustomer(@RequestParam("name") String name,
			@RequestParam("surname") String surname, @RequestParam("fiscal_id") String fiscal_id,
			@RequestParam("date_patent") String date_patent,@RequestParam("history_events") String history_events) {
		Customer customer = new Customer(name, surname, fiscal_id, date_patent, history_events);
